# Cookiecutter NodeJS Quick Start Web Application
...
* **NodeJS {{cookiecutter.options[cookiecutter.runtime].version}}**: `sam init --runtime {{ cookiecutter.runtime }} --app-template quick-start-full-stack --name full-stack-app`
