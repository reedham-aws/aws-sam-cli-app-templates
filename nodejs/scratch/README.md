# Cookiecutter NodeJS "From Scratch" Quick Start Application
...
* **NodeJS {{cookiecutter.options[cookiecutter.runtime].version}}**: `sam init --runtime {{cookiecutter.runtime}} --app-template quick-start-from-scratch --name sam-app`
